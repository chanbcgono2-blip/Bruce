...
namespace Project11
{
    public class Animation
    {
        ...
        {
            var frameWidth = _sourceRectangles[_frame].Width;
            var frameHeight = _sourceRectangles[_frame].Height;
            var origin = new Vector2(frameWidth / 2, frameHeight / 2);
            Globals.SpriteBatch.Draw(_texture, pos, _sourceRectangles[_frame], Color.White, 0, origin, Vector2.One, SpriteEffects.None, 1);
        }
    }
}
